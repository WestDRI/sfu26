...
**Date and time:** \
Friday, June 5, 2026, 9:30am-4:30pm (all day with a one-hour lunch break 12:30pm-1:30pm)
...
**Workshop material:** \
[Towards high-performance Python](https://folio.vastcloud.org/pythonhpc) \
[Distributed computing with Ray](https://folio.vastcloud.org/ray) \
[Numba JIT compilation to CUDA kernels](https://folio.vastcloud.org/numba-gpu)
