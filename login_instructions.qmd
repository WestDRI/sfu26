...
If you want to copy/paste the password, you can paste in the MobaXterm terminal by:

- pressing [Shift+Insert]{.codelike} or
- right-clicking with your mouse (you might have to enable this by going to [Settings]{.codelike} > [Configuration]{.codelike} > [Terminal]{.codelike} and checking [Paste using right-click]{.codelike}) or
