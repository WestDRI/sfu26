---
title: Introduction to parallel programming in Chapel
description: |
...
**Date and time:** \
Thursday, June 4, 2026, 1:30pm-4:30pm (afternoon session)
...
**Workshop material:** \
[Parallel programming in Chapel](https://folio.vastcloud.org/chapel) \
[GPU computing with Chapel](https://folio.vastcloud.org/chapel-gpu)
